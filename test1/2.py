...
at_least_5_papers = sum([value for key, value in papers_and_freq if key >= 5])
total_values = sum([value for key, value in papers_and_freq])
print("at least 5 papers: {}".format(at_least_5_papers))
